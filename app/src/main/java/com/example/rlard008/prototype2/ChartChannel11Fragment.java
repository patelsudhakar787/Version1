...
public class ChartChannel11Fragment extends Fragment {
    GraphView graphView;
    ...
    public void getRequest()
    {
        ...
        response.enqueue(new Callback<SelectPojo>() {
         ...
         try {
             ...
             String channel1 = d.getChannel_11();

             values.add(Double.parseDouble(channel1));
             Log.e("Channel11", "" + channel1);
             double data=Double.parseDouble(channel1);
             if(data>4){
                 String message="Channel11ValueReachedThreshold";
