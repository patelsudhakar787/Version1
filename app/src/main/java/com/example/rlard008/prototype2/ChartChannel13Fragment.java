...
public class ChartChannel13Fragment extends Fragment {
    GraphView graphView;
        ...
        response.enqueue(new Callback<SelectPojo>() {
            ...
            //    Log.e("ResponseRetrofit",""+response.body().getData());
              try {
                  ...
                  String channel1 = d.getChannel_13();

                  values.add(Double.parseDouble(channel1));
                  Log.e("Channel13", "" + channel1);
                  double data=Double.parseDouble(channel1);
                  if(data>4){
                      String message="Channel13ValueReachedThreshold";
