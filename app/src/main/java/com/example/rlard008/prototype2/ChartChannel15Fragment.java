...
public class ChartChannel15Fragment  extends Fragment {
    GraphView graphView;
    ...
    public void getRequest()
    {
        ...
        response.enqueue(new Callback<SelectPojo>() {
          ...
          try {
              ...
              String channel1 = d.getChannel_15();

              values.add(Double.parseDouble(channel1));
              Log.e("Channel15", "" + channel1);
              double data=Double.parseDouble(channel1);
              if(data>4){
                  String message="Channel15ValueReachedThreshold";
