...
public class ChartChannel16Fragment extends Fragment {
    GraphView graphView;
  //  TextView textView;
        ...
        response.enqueue(new Callback<SelectPojo>() {
            ...
            public void onResponse(Call<SelectPojo> call, retrofit2.Response<SelectPojo> response) {
             ...
             try {
                 ...
                 String channel1 = d.getChannel_16();

                 values.add(Double.parseDouble(channel1));
                 Log.e("Channel16", "" + channel1);
                 double data=Double.parseDouble(channel1);
                 if(data>4){
                     String message="Channel16ValueReachedThreshold";
