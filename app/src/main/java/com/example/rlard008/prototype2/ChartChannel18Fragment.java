...
public class ChartChannel18Fragment extends Fragment {
    GraphView graphView;
        ...
        response.enqueue(new Callback<SelectPojo>() {
           ...
           //     Log.e("ResponseRetrofit",""+response.body().getData());
              ...
              try {
                  ...
                  String channel1 = d.getChannel_18();

                  values.add(Double.parseDouble(channel1));
                  Log.e("Channel18", "" + channel1);
                  double data=Double.parseDouble(channel1);
                  if(data>100){
                      String message="Channel18ValueReachedThreshold";
