...
public class ChartChannel24Fragment extends Fragment {
    GraphView graphView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        graphView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in=new Intent(getContext(),ShowEnlargeChart17_24Activity.class);
    ...
    public void getRequest()
    {
        ...
        response.enqueue(new Callback<SelectPojo>() {
           ...
           try {
               ...
               String channel1 = d.getChannel_24();

               values.add(Double.parseDouble(channel1));
               Log.e("Channel24", "" + channel1);
               double data=Double.parseDouble(channel1);
               if(data>100){
                   String message="Channel24ValueReachedThreshold";
