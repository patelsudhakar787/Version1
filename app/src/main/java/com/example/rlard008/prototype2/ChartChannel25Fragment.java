...
public class ChartChannel25Fragment extends Fragment {
    GraphView graphView;
                    ...
                    public void run() {
                        try {
                          ...
                          minutes = d.getMinutes();
                            minute.add(minutes);
                           Log.e("ArrayListofMinute 25", "" + minute);
                            getRequest();
                            int i = minute.size();
                            int j = values.size();
                            ...
                            qwerty.add(dpoint);
                            Log.e("Channel---25", "" + qwerty);
                            Log.e("ArrayListOfDataPoint 25", "" + qwerty);
        ...
        response.enqueue(new Callback<SelectPojo>() {
            ...
            public void onResponse(Call<SelectPojo> call, retrofit2.Response<SelectPojo> response) {
              try {
                  ...
                  String channel1 = d.getChannel_25();

                  values.add(Double.parseDouble(channel1));
                  Log.e("Channel25", "" + channel1);
                  double data=Double.parseDouble(channel1);
                  if(data>100){
                      String message="Channel25ValueReachedThreshold";
