...
public class ChartChannel29Fragment extends Fragment {
    GraphView graphView;
  //  TextView textView;
    ...
    public void getRequest()
    {
       ...
       //         Log.e("ResponseRetrofit",""+response.body().getData());
         try {
             ...
             String channel1 = d.getChannel_29();

             values.add(Double.parseDouble(channel1));
             Log.e("Channel29", "" + channel1);
             double data=Double.parseDouble(channel1);
             if(data>100){
                 String message="Channel29ValueReachedThreshold";
