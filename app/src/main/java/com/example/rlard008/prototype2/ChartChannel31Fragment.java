...
public class ChartChannel31Fragment extends Fragment {
    GraphView graphView;
        ...
        response.enqueue(new Callback<SelectPojo>() {
          ...
          //      Log.e("ResponseRetrofit",""+response.body().getData());
               try {
                   ...
                   String channel1=d.getChannel_31();

                   values.add(Double.parseDouble(channel1));
                   Log.e("Channel31",""+channel1);

                   double data=Double.parseDouble(channel1);
                   if(data>100){
                       String message="Channel31ValueReachedThreshold";
