...
public class ChartChannel32Fragment extends Fragment {
    GraphView graphView;
 //   TextView textView;
        ...
        response.enqueue(new Callback<SelectPojo>() {
         ...
         //       Log.e("ResponseRetrofit",""+response.body().getData());
                try {
                    ...
                    String channel1 = d.getChannel_32();

                    values.add(Double.parseDouble(channel1));
                    Log.e("Channel32", "" + channel1);

                    double data=Double.parseDouble(channel1);
                    if(data>100){
                        String message="Channel32ValueReachedThreshold";
