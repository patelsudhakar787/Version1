    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
           ...
           //     attemptLogin();
                ...
                url = "http://10.10.0.220:7070/VibeScopeV1/LoginServlet?email="+email+"&password="+password;
...
//                startActivity(intent);
                ...
                url1="http://10.10.0.220:7070/VibeScopeV1/TokenServlet?client_id=A1001&token_id="+refreshToken;
...
//            url = "http://10.10.0.120:7070/VibeScopeV1/LoginServlet?email="+email+"&password="+password;
//            sendRequest();
            showProgress(true);
