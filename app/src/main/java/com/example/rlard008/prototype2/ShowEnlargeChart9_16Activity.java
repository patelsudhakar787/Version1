...
public class ShowEnlargeChart9_16Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(ShowEnlargeChart9_16Activity.this,"Minute"+minute,Toast.LENGTH_LONG).show();
      //  Toast.makeText(ShowEnlargeChart9_16Activity.this,"Values"+values,Toast.LENGTH_LONG).show();


        RealmConfiguration config=new RealmConfiguration.Builder(ShowEnlargeChart9_16Activity.this).build();
      ...
      //  Toast.makeText(ShowEnlargeChart9_16Activity.this,"RealmDataBase->"+channel,Toast.LENGTH_LONG).show();
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                 ...
                 //       Toast.makeText(ShowEnlargeChart9_16Activity.this,"QWERTY"+qwerty,Toast.LENGTH_LONG).show();
                    ...
                    {
                        Toast.makeText(ShowEnlargeChart9_16Activity.this,"Nothing  To Show On Graph",Toast.LENGTH_LONG).show();
                    }
...
//                                values = (ArrayList<Double>) intent1.getSerializableExtra("val");
                           ...
                           // getRequest();
                            ...
                            if(minutes==59.0)
                            {
                                Intent intent3=new Intent(ShowEnlargeChart9_16Activity.this,MainActivity.class);
        ...
        textView1.setOnClickListener(new View.OnClickListener() {
            ...
            //    Toast.makeText(ShowEnlargeChart9_16Activity.this,"Data2daysago"+twodaysago,Toast.LENGTH_LONG).show();
                Intent intent1 = new Intent(ShowEnlargeChart9_16Activity.this, GraphViewCalenderActivity.class);
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             //   Toast.makeText(ShowEnlargeChart9_16Activity.this,"Yesterday"+yesterday,Toast.LENGTH_LONG).show();
                Intent intent2 = new Intent(ShowEnlargeChart9_16Activity.this, GraphViewCalenderActivity.class);
        ...
        textView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ShowEnlargeChart9_16Activity.this);
                final DatePicker picker = new DatePicker(ShowEnlargeChart9_16Activity.this);
                ...
                builder.setPositiveButton("Set", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(ShowEnlargeChart9_16Activity.this, GraphViewCalenderActivity.class);
        ...
        StringRequest stringRequest=new StringRequest(url,new Response.Listener<String>() {
            ...
            //    Log.e("Response",""+response);
                try {
                    ...
                    if(channel.equals("channel_9")) {
                        Toast.makeText(ShowEnlargeChart9_16Activity.this,"Hello",Toast.LENGTH_LONG).show();
                        double d=jobj1.getDouble("channel_9");
                        editText.setText(""+d);
                        values.add(d);

                    }

                    if(channel.equals("channel_10"))
                    {
                        double d=jobj1.getDouble("channel_10");
                        editText.setText(""+d);
                        values.add(d);

                    }
                    if(channel.equals("channel_11"))
                    {
                        double d=jobj1.getDouble("channel_11");
                        editText.setText(""+d);
                        values.add(d);

                    }

                    if(channel.equals("channel_12"))
                    {
                        double d=jobj1.getDouble("channel_12");
                        editText.setText(""+d);
                        values.add(d);
                    }

                    if(channel.equals("channel_13"))
                    {
                        double d=jobj1.getDouble("channel_13");
                        editText.setText(""+d);
                        values.add(d);

                    }

                    if(channel.equals("channel_14"))
                    {
                        double d=jobj1.getDouble("channel_14");
                        editText.setText(""+d);
                        values.add(d);
                    }

                    if(channel.equals("channel_15"))
                    {
                        double d=jobj1.getDouble("channel_15");
                        editText.setText(""+d);
                        values.add(d);

                    }

                    if(channel.equals("channel_16"))
                    {
                        double d=jobj1.getDouble("channel_16");
                        editText.setText(""+d);
                        values.add(d);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowEnlargeChart9_16Activity.this,"Error"+error,Toast.LENGTH_LONG).show();
    ...
    public void sendRequest1()
    {
        StringRequest stringRequest=new StringRequest(urllistView, new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowEnlargeChart9_16Activity.this,"Limited Connection",Toast.LENGTH_LONG).show();
            }
        });
        RequestQueue requestQueue=Volley.newRequestQueue(this);
        requestQueue.add(stringRequest);
    ...
    public class ListViewAdapter extends ArrayAdapter<Parameter>
    {
        ...
        public ListViewAdapter() {
            super(ShowEnlargeChart9_16Activity.this,R.layout.listview_enlarge_chart,arrayList);
        }
    ...
    public void getRequest()
    {
        ...
        response.enqueue(new Callback<SelectPojo>() {
           ...
           try {
               ...
               if (channel.equals("channel_9")) {
                   String channel9 = d.getChanne_9();
                   values.add(Double.parseDouble(channel9));
                   editText.setText("" + channel9);
               }

               if (channel.equals("channel_10")) {
                   String channel10 = d.getChannel_10();
                   values.add(Double.parseDouble(channel10));
                   editText.setText("" + channel10);
               }
               if (channel.equals("channel_11")) {
                   String channel11 = d.getChannel_11();
                   values.add(Double.parseDouble(channel11));
                   editText.setText("" + channel11);
               }

               if (channel.equals("channel_12")) {
                   String channel12 = d.getChannel_12();
                   values.add(Double.parseDouble(channel12));
                   editText.setText("" + channel12);
               }

               if (channel.equals("channel_13")) {
                   String channel13 = d.getChannel_13();
                   values.add(Double.parseDouble(channel13));
                   editText.setText("" + channel13);
               }
               if (channel.equals("channel_14")) {
                   String channel14 = d.getChannel_14();
                   values.add(Double.parseDouble(channel14));
                   editText.setText("" + channel14);
               }

               if (channel.equals("channel_15")) {
                   String channel15 = d.getChannel_15();
                   values.add(Double.parseDouble(channel15));
                   editText.setText("" + channel15);
               }

               if (channel.equals("channel_16")) {
                   String channel16 = d.getChannel_16();
                   values.add(Double.parseDouble(channel16));
                   editText.setText("" + channel16);
               }
